...
pluralCaseList.push( {plural: "customers/cutomers", pascal: "CustomerCutomer"} )

pluralCaseList.push( {plural: "moves/moves", pascal: "MoveMove"} )

pluralCaseList.push( {plural: "families/families", pascal: "FamilyFamily"} )

pluralCaseList.push( {plural: "alarms/alarms", pascal: "AlarmAlarm"} )

pluralCaseList.push( {plural: "locations/locations", pascal: "LocationLocation"} )
